...
const [textTitleOrderStep, textTitleOrderStepAttrs] = defineField('textTitleOrderStep')
const [textSubtitleOrderStep, textSubtitleOrderStepAttrs] = defineField('textSubtitleOrderStep')
    ...
    <div class="flex justify-between items-start mb-6">
      <div>
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
          Textos de la Sección de Pasos / Órdenes
        </h2>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Personaliza el título y subtítulo principal que aparecen en esta sección.
        </p>
      </div>
    ...
    <form @submit.prevent="onSubmit" class="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          v-model="textTitleOrderStep"
          v-bind="textTitleOrderStepAttrs"
          type="text"
          :disabled="!isEditing"
          ...
          "
        />
        <span v-if="errors.textTitleOrderStep" class="text-red-500 text-xs mt-1 block">
          {{ errors.textTitleOrderStep }}
        </span>
      </div>
      ...
      <div>
        ...
        <input
          v-model="textSubtitleOrderStep"
          v-bind="textSubtitleOrderStepAttrs"
          type="text"
          :disabled="!isEditing"
          class="w-full rounded-lg px-3 py-2 text-sm transition-colors border"
          :class="
          ...
          "
        />
        <span v-if="errors.textSubtitleOrderStep" class="text-red-500 text-xs mt-1 block">
          {{ errors.textSubtitleOrderStep }}
        </span>
      </div>
